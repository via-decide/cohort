...
CONSTRAINTS
Isolate the vote tallying algorithm, the WebSocket sync-timer, and the chat-overlay logic. @GN8RBot MUST test the voting math for edge cases (e.g., 50/50 ties) before committing.
